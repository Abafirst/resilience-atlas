...
app.use("/api/iatlas/analytics", require("./routes/iatlas-analytics"));
console.log("✅ Mounted route: /api/iatlas/analytics");
app.use("/api/iatlas/parent", require("./routes/iatlas-parent"));
console.log("✅ Mounted route: /api/iatlas/parent");
app.use("/api/iatlas/mini-assessments", require("./routes/iatlas-mini-assessments"));
console.log("✅ Mounted route: /api/iatlas/mini-assessments");
app.use("/api/iatlas/parent-outcomes", require("./routes/iatlas-parent-outcomes"));
console.log("✅ Mounted route: /api/iatlas/parent-outcomes");
...
app.use("/api/clinical/scales", require("./routes/clinical/scales"));
console.log("✅ Mounted route: /api/clinical/scales (PHQ-9, GAD-7)");
