...
// ── IARF Skill Badges ─────────────────────────────────────────────────────────
// Dimension-specific badges earned through IARF curriculum skill development.

export const IARF_SKILL_BADGES = [
  // Skill badges (dimension-specific)
  {
    id:          'goal-setter',
    label:       'Goal Setter',
    emoji:       '🎯',
    description: 'Completed the Agentic-Generative Foundation level — values identification and basic goal setting.',
    dimension:   'Agentic-Generative',
    rarity:      'common',
    tier:        'starter',
  ...
  },
  {
    ...
    label:       'Connection Keeper',
    emoji:       '💬',
    description: 'Completed the Relational-Connective Foundation level — authentic outreach and support mapping.',
    dimension:   'Relational-Connective',
    rarity:      'common',
    tier:        'starter',
  ...
  },
  {
    ...
    label:       'Breath Master',
    emoji:       '🧘',
    description: 'Completed the Somatic-Regulative Foundation level — nervous system literacy and somatic practices.',
    dimension:   'Somatic-Regulative',
    rarity:      'uncommon',
    tier:        'starter',
  ...
  {
    id:          'reframe-champion',
    label:       'Reframe Champion',
    emoji:       '🔄',
    description: 'Completed the Cognitive-Narrative Foundation level — cognitive defusion and narrative flexibility.',
    dimension:   'Cognitive-Narrative',
    rarity:      'uncommon',
    tier:        'starter',
  ...
  {
    id:          'emotion-navigator',
    label:       'Emotion Navigator',
    emoji:       '💙',
    description: 'Completed the Emotional-Adaptive Foundation level — emotion naming and willingness practice.',
    dimension:   'Emotional-Adaptive',
    rarity:      'uncommon',
    tier:        'starter',
  ...
  },
  {
    ...
    label:       'Values Anchor',
    emoji:       '✨',
    description: 'Completed the Spiritual-Reflective Foundation level — values clarification and meaning-making.',
    dimension:   'Spiritual-Reflective',
    rarity:      'uncommon',
    tier:        'starter',
  ...
  // Milestone badges
  {
    id:          'first-micropractice',
    label:       'First Micropractice',
    emoji:       '🌟',
    description: 'Completed your first IARF micropractice — your resilience journey has begun.',
    dimension:   null,
    rarity:      'common',
    tier:        'starter',
    icon:        '/icons/star.svg',
  ...
  },
  {
    ...
    emoji:       '📈',
    description: 'Completed your first Resilience Atlas assessment.',
    dimension:   null,
    rarity:      'common',
    tier:        'starter',
  ...
  {
    id:          'first-reassessment',
    label:       'First Re-Assessment',
    emoji:       '🔄',
    description: 'Retook the Resilience Atlas — tracking your growth over time.',
    dimension:   null,
    rarity:      'uncommon',
    tier:        'starter',
  ...
  {
    id:          '30-day-active',
    label:       '30-Day Active User',
    emoji:       '🎊',
    description: 'Actively engaged with the platform for 30 days.',
    dimension:   null,
    rarity:      'uncommon',
    tier:        'starter',
    icon:        '/icons/streaks.svg',
  ...
  {
    id:          '90-day-transformer',
    label:       '90-Day Transformer',
    emoji:       '👑',
    description: 'Sustained active engagement for 90 days — a true resilience transformation.',
    dimension:   null,
    rarity:      'rare',
    tier:        'navigator',
    icon:        '/icons/kids-trophy.svg',
  ...
  // Achievement badges
  {
    ...
    label:       'Early Adopter',
    emoji:       '🚀',
    description: 'Among the first to join the IARF gamification system.',
    dimension:   null,
    rarity:      'rare',
    tier:        'starter',
    icon:        '/icons/star.svg',
  ...
  {
    id:          'skill-completionist',
    label:       'Skill Completionist',
    emoji:       '🎓',
    description: 'Completed all skills in one dimension (all 3 pathway levels).',
    dimension:   null,
    rarity:      'rare',
    tier:        'navigator',
    icon:        '/icons/game-mountain.svg',
  ...
  {
    id:          'rainbow-resilience',
    label:       'Rainbow Resilience',
    emoji:       '🌈',
    description: 'Completed at least one practice in all 6 resilience dimensions.',
    dimension:   null,
    rarity:      'rare',
    tier:        'navigator',
    icon:        '/icons/compass.svg',
  ...
  },
  {
    ...
    emoji:       '🔥',
    description: 'Maintained a 100-day continuous practice streak.',
    dimension:   null,
    rarity:      'legendary',
    tier:        'navigator',
    icon:        '/icons/streaks.svg',
  ...
  },
  {
    ...
    emoji:       '🤝',
    description: 'Helped another user on their resilience journey.',
    dimension:   null,
    rarity:      'uncommon',
    tier:        'navigator',
    icon:        '/icons/game-shield.svg',
  ...
  // Dimensional mastery badges
  {
    id:          'agentic-master',
    label:       'Agentic Master',
    emoji:       '🏆',
    description: 'Completed all 3 levels of the Agentic-Generative pathway — resilient agency achieved.',
    dimension:   'Agentic-Generative',
    rarity:      'rare',
    tier:        'navigator',
    icon:        '/icons/agentic-generative.svg',
  ...
  {
    id:          'relational-master',
    label:       'Relational Master',
    emoji:       '🏆',
    description: 'Completed all 3 levels of the Relational-Connective pathway.',
    dimension:   'Relational-Connective',
    rarity:      'rare',
    tier:        'navigator',
    icon:        '/icons/relational-connective.svg',
  ...
  {
    id:          'somatic-master',
    label:       'Somatic Master',
    emoji:       '🏆',
    description: 'Completed all 3 levels of the Somatic-Regulative pathway.',
    dimension:   'Somatic-Regulative',
    rarity:      'rare',
    tier:        'navigator',
    icon:        '/icons/somatic-regulative.svg',
  ...
  {
    id:          'cognitive-master',
    label:       'Cognitive Master',
    emoji:       '🏆',
    description: 'Completed all 3 levels of the Cognitive-Narrative pathway.',
    dimension:   'Cognitive-Narrative',
    rarity:      'rare',
    tier:        'navigator',
    icon:        '/icons/cognitive-narrative.svg',
  ...
  },
  {
    ...
    emoji:       '🏆',
    description: 'Completed all 3 levels of the Emotional-Adaptive pathway.',
    dimension:   'Emotional-Adaptive',
    rarity:      'rare',
    tier:        'navigator',
    icon:        '/icons/emotional-adaptive.svg',
  ...
  },
  {
    ...
    emoji:       '🏆',
    description: 'Completed all 3 levels of the Spiritual-Reflective pathway.',
    dimension:   'Spiritual-Reflective',
    rarity:      'rare',
    tier:        'navigator',
    icon:        '/icons/spiritual-reflective.svg',
  ...
  // Specialist & Renaissance badges
  {
    id:          'dimension-specialist',
    label:       'Dimension Specialist',
    emoji:       '🎯',
    description: 'Developed one dimension to 90%+ score — the Specialist Path.',
    dimension:   null,
    rarity:      'legendary',
    tier:        'navigator',
    icon:        '/icons/star.svg',
  ...
  },
  {
    ...
    label:       'Renaissance Resilience',
    emoji:       '🌟',
    description: 'Maintained 70%+ across all 6 dimensions — the Renaissance Path.',
    dimension:   null,
    rarity:      'legendary',
    tier:        'navigator',
    icon:        '/icons/compass.svg',
...
// ── IARF Quest Types ──────────────────────────────────────────────────────────
// Quest type metadata for categorization and display.

export const IARF_QUEST_TYPES = {
  foundation: { label: '🌱 Foundation Quest', description: 'Beginner-friendly, single-dimension focus', color: '#22c55e', xpMultiplier: 1.0 },
  sprint:     { label: '⚡ Sprint Quest',     description: '7-day intensive challenge', color: '#3b82f6', xpMultiplier: 1.25 },
  epic:       { label: '🏔️ Epic Quest',       description: '90-day transformational journey', color: '#8b5cf6', xpMultiplier: 1.75 },
  deepdive:   { label: '🎯 Dimensional Deep-Dive', description: 'Focus on one dimension at a time', color: '#f59e0b', xpMultiplier: 1.5 },
};

// ── IARF Long-Form Quests ─────────────────────────────────────────────────────
// Multi-week quests for the Navigator tier.

export const IARF_LONG_QUESTS = [
  {
    id:          'iq-30-day-foundation',
    type:        'epic',
    title:       '30-Day Resilience Foundation',
    tagline:     'Build a solid resilience foundation across all 6 dimensions in 30 structured days.',
    totalDays:   30,
    totalXP:     450,
    badgeId:     '30-day-transformer',
    badgeLabel:  '30-Day Resilience Transformer',
    tier:        'navigator',
    phases: [
      { days: '1-7',   dimension: 'Somatic-Regulative',   focus: 'Establish daily breathwork and body awareness',   icon: '/icons/somatic-regulative.svg'   },
      { days: '8-14',  dimension: 'Cognitive-Narrative',  focus: 'Practice reframing and cognitive flexibility',    icon: '/icons/cognitive-narrative.svg'  },
      { days: '15-21', dimension: 'Relational-Connective',focus: 'Connect with support and build relational skills', icon: '/icons/relational-connective.svg' },
      { days: '22-28', dimension: 'Emotional-Adaptive',   focus: 'Emotion tracking and adaptive responses',         icon: '/icons/emotional-adaptive.svg'   },
      { days: '29-30', dimension: null,                   focus: 'Integration: reflect and plan your resilience journey forward', icon: '/icons/compass.svg' },
    ],
    xpReward:    450,
    xpMultiplier: 1.5,  // 1.5x XP multiplier for the following week
    description: 'A structured 30-day journey through the IARF framework. Each phase builds on the previous, creating an integrated resilience practice grounded in ABA and ACT principles.',
  },
  {
    id:          'iq-7-day-somatic-sprint',
    type:        'sprint',
    title:       '7-Day Somatic Sprint',
    tagline:     'A 7-day intensive somatic regulation practice — from nervous system literacy to daily regulation.',
    totalDays:   7,
    totalXP:     120,
    badgeId:     'somatic-sprint-champion',
    badgeLabel:  'Somatic Sprint Champion',
    tier:        'navigator',
    phases: [
      { days: '1-3', dimension: 'Somatic-Regulative', focus: 'Nervous system fundamentals and body scan practice', icon: '/icons/somatic-regulative.svg' },
      { days: '4-5', dimension: 'Somatic-Regulative', focus: 'Somatic cue identification and regulation toolkit', icon: '/icons/somatic-regulative.svg'  },
      { days: '6-7', dimension: 'Somatic-Regulative', focus: 'Build your personalized somatic intervention plan', icon: '/icons/somatic-regulative.svg'  },
    ],
    xpReward:    120,
    xpMultiplier: 1.25,
    description: 'Deep-dive into somatic resilience with daily breathwork, body awareness, and physiological regulation practices.',
  },
  {
    id:          'iq-agentic-deepdive',
    type:        'deepdive',
    title:       'Agentic Deep-Dive',
    tagline:     'Master purposeful action, goal-setting, and values-aligned agency over 14 focused days.',
    totalDays:   14,
    totalXP:     200,
    badgeId:     'agentic-deep-explorer',
    badgeLabel:  'Agentic Deep-Diver',
    tier:        'navigator',
    phases: [
      { days: '1-5',  dimension: 'Agentic-Generative', focus: 'Values identification and goal-setting foundations', icon: '/icons/agentic-generative.svg' },
      { days: '6-10', dimension: 'Agentic-Generative', focus: 'Barrier navigation and flexible problem-solving', icon: '/icons/agentic-generative.svg'    },
      { days: '11-14', dimension: 'Agentic-Generative', focus: 'Long-range vision and committed action planning', icon: '/icons/agentic-generative.svg'  },
    ],
    xpReward:    200,
    xpMultiplier: 1.5,
    description: 'A focused 14-day exploration of the Agentic-Generative dimension using the full IARF skills inventory.',
  },
  {
    id:          'iq-first-steps',
    type:        'foundation',
    title:       'First Steps Foundation',
    tagline:     'A gentle 5-day introduction to IARF resilience practices across the core dimensions.',
    totalDays:   5,
    totalXP:     80,
    badgeId:     'first-steps-complete',
    badgeLabel:  'First Steps Complete',
    tier:        'starter',
    phases: [
      { days: '1',   dimension: 'Somatic-Regulative',    focus: 'Complete your first somatic micropractice',    icon: '/icons/somatic-regulative.svg'   },
      { days: '2',   dimension: 'Cognitive-Narrative',   focus: 'Complete your first cognitive micropractice',  icon: '/icons/cognitive-narrative.svg'  },
      { days: '3',   dimension: 'Relational-Connective', focus: 'Complete your first relational micropractice', icon: '/icons/relational-connective.svg' },
      { days: '4',   dimension: 'Emotional-Adaptive',    focus: 'Complete your first emotional micropractice',  icon: '/icons/emotional-adaptive.svg'   },
      { days: '5',   dimension: 'Agentic-Generative',    focus: 'Complete your first agentic micropractice',    icon: '/icons/agentic-generative.svg'   },
    ],
    xpReward:    80,
    xpMultiplier: 1.0,
