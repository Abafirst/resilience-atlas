...
// ── Adult Quests ─────────────────────────────────────────────────────────────
// Multi-step resilience missions with tier gating.
// tier: 'starter' → both Starter and Navigator can play
// tier: 'navigator' → Navigator only; Starter sees a locked preview + upgrade CTA

export const ADULT_QUESTS = [
  {
    id:          'quest-dimension-discovery',
    title:       'Dimension Discovery',
    subtitle:    'Your first resilience journey',
    description: 'Explore three different resilience dimensions through short, guided practices. Build awareness of your strengths and discover where growth is calling.',
    tier:        'starter',
    days:        '3 steps',
    totalSteps:  3,
    ...
    color:       '#eff6ff',
    accentColor: '#3b82f6',
    reward:      { stars: 20, badgeName: 'Dimension Seeker', badgeIcon: '/icons/compass.svg', badgeRarity: 'rare' },
    steps: [
      {
        id:       'quest-dd-step1',
        title:    'Agentic-Generative Practice',
        subtitle: 'Values-Aligned Action',
        duration: '5 min',
        dimension:'Agentic-Generative',
        prompt:   'Name a value that matters to you. Then write one small, concrete action you can take in the next 24 hours that moves toward that value.',
        reflection:'What barrier might arise, and what is one way to move through it rather than around it?',
        points:   5,
      },
      {
        id:       'quest-dd-step2',
        title:    'Emotional-Adaptive Practice',
        subtitle: 'Emotion Naming',
        duration: '5 min',
        dimension:'Emotional-Adaptive',
        prompt:   'Take 60 seconds and identify what you are feeling right now — use specific words (e.g., "frustrated-but-hopeful"). Write 3 emotion words. Then observe: what do you notice after naming?',
        reflection:'What story does your mind attach to these emotions? Can you hold that story lightly?',
        points:   5,
      },
      {
        id:       'quest-dd-step3',
        title:    'Somatic-Regulative Practice',
        subtitle: 'Physiological Reset',
        duration: '5 min',
        dimension:'Somatic-Regulative',
        prompt:   'Practice the physiological sigh: inhale fully, take a short second inhale on top, then exhale slowly. Repeat 3 times. Notice your body afterward — where is there tension? Where is there ease?',
        reflection:'What does your body tell you about your current stress level?',
        points:   5,
      },
    ],
  },
  {
    id:          'quest-values-alignment',
    title:       'Values Alignment Sprint',
    subtitle:    '7-day values practice',
    description: 'Deepen your connection to what matters most. This quest guides you through values clarification, committed action, and meaning-making — the foundation of lasting resilience.',
    tier:        'navigator',
    days:        '4 steps',
    totalSteps:  4,
    dimension:   'Spiritual-Reflective',
    ...
    color:       '#fffbeb',
    accentColor: '#f59e0b',
    reward:      { stars: 50, badgeName: 'Values Champion', badgeIcon: '/icons/spiritual-reflective.svg', badgeRarity: 'uncommon' },
    steps: [
      {
        id:       'quest-va-step1',
        title:    'Values Identification',
        ...
        duration: '10 min',
        dimension:'Spiritual-Reflective',
        prompt:   'Name 3 values that, if you were living them fully, would make your life feel deeply meaningful. For each, write one specific way your current behavior reflects — or fails to reflect — that value.',
        reflection:'What would it look like to live even 10% more aligned with these values this week?',
        points:   10,
      },
      {
        id:       'quest-va-step2',
        title:    'Values-in-Action',
        subtitle: 'Commit to one value',
        duration: '15 min',
        dimension:'Spiritual-Reflective',
        prompt:   'Choose one value from Step 1. Write about it freely for 10 minutes: When did you first recognize this value in yourself? What happens in your body when you are living it? When you deviate from it?',
        reflection:'What committed action — however small — could you take today in service of this value?',
        points:   15,
      },
      {
        id:       'quest-va-step3',
        title:    'Relational Values Practice',
        subtitle: 'Connection as commitment',
        duration: '10 min',
        dimension:'Relational-Connective',
        prompt:   'Identify one relationship you want to deepen. Write a brief, authentic message to that person — not transactional, not obligatory. Share something you genuinely appreciate about them.',
        reflection:'What value were you acting toward by reaching out? What made it feel uncomfortable or real?',
        points:   15,
      },
      {
        id:       'quest-va-step4',
        title:    'Meaning Architecture',
        subtitle: 'The story you are writing',
        duration: '15 min',
        dimension:'Cognitive-Narrative',
        prompt:   'Write the story you want to tell about the next 90 days of your life — from the perspective of your future self looking back. What did you build? What did you stand for?',
        reflection:'What is one thing you can do today that will make the story you are writing worth reading?',
        points:   10,
      },
    ],
  ...
  {
    id:          'quest-regulation-mastery',
    title:       'Regulation Mastery',
    subtitle:    'Command your nervous system',
    description: 'Build genuine physiological flexibility — the capacity to move between activation and recovery with awareness and skill. Grounded in evidence-based somatic and cognitive practices.',
    tier:        'navigator',
    days:        '3 steps',
    totalSteps:  3,
    dimension:   'Somatic-Regulative',
    ...
    color:       '#ecfeff',
    accentColor: '#06b6d4',
    reward:      { stars: 35, badgeName: 'Regulation Master', badgeIcon: '/icons/somatic-regulative.svg', badgeRarity: 'uncommon' },
    steps: [
      {
        id:       'quest-rm-step1',
        title:    'Nervous System Literacy',
        ...
        duration: '10 min',
        dimension:'Somatic-Regulative',
        prompt:   'Complete a 5-minute body scan from head to toe. Then write: Where is tension living in your body right now? What antecedent (event, thought, environment) might have contributed? What is one micro-intervention you could apply?',
        reflection:'What physical sensations do you most often ignore under stress? What might they be trying to tell you?',
        points:   10,
      },
      {
        id:       'quest-rm-step2',
        title:    'Cognitive Regulation',
        subtitle: 'Defuse from the narrative',
        duration: '15 min',
        dimension:'Cognitive-Narrative',
        prompt:   'Identify one recurring thought that amplifies your stress (e.g., "I can\'t handle this," "Everything is falling apart"). Write it down. Now prefix it: "I notice I\'m having the thought that…" Notice the shift. Write 3 pieces of evidence that challenge this narrative.',
        reflection:'What would be available to you if you held this thought as a passing mental event rather than a fact?',
        points:   15,
      },
      {
        id:       'quest-rm-step3',
        title:    'Somatic Protocol Design',
        subtitle: 'Your personal regulation plan',
        duration: '20 min',
        dimension:'Somatic-Regulative',
        prompt:   'Build your personal somatic protocol: (1) Name your highest-stress recurring context. (2) Design one pre-event regulation practice. (3) Design one in-the-moment technique. (4) Design one post-event recovery practice. Write each as a specific, actionable step you can actually use.',
        reflection:'What would consistent somatic regulation make possible that is currently blocked by reactivity?',
        points:   10,
      },
    ],
  },
