            ...
            return (
              ...
              >
                <div className="kg-quest-card-top">
                  ...
                  {isDone && <span className="kg-quest-done-badge" aria-label="Series complete">✅</span>}
                </div>
            ...
            <div className="kg-challenge-list" role="list">
              {part.challenges.map(c => (
                ...
                >
                  ...
                  <span>{c.label}</span>
                  {challenges[c.id] && <span className="kg-check" aria-hidden="true">✓</span>}
                </button>
              ))}
            </div>
            {part.encouragement && (
