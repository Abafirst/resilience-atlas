      ...
      >
        ...
        <div style={s.body}>
          ...
          <div style={s.sectionLabel(color)}>
            <img src="/icons/info.svg" alt="" aria-hidden="true" width={14} height={14} style={{ verticalAlign: 'text-bottom', marginRight: 6 }} /> Why It Matters
          </div>
          <p style={s.p}>{whyItMatters}</p>

          {/* How to improve */}
          <div style={s.sectionLabel(color)}>
            <img src="/icons/goal.svg" alt="" aria-hidden="true" width={14} height={14} style={{ verticalAlign: 'text-bottom', marginRight: 6 }} /> How to Strengthen This Dimension
          </div>
          ...
          {/* Examples */}
          <div style={s.sectionLabel(color)}>
            <img src="/icons/growth.svg" alt="" aria-hidden="true" width={14} height={14} style={{ verticalAlign: 'text-bottom', marginRight: 6 }} /> Real-World Examples
          </div>
          {examples.map((ex, i) => (
