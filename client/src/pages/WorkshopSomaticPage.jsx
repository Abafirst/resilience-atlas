...
export default function WorkshopSomaticPage() {
  useEffect(() => {
    try {
    ...
    <>
      ...
      <div className="guide">
        ...
        <header className="guide-header">
          ...
          <h1 className="guide-header__title">Somatic-Behavioral</h1>
          <p className="guide-header__sub">A facilitated team session to explore and strengthen Somatic-Behavioral resilience</p>
        ...
        <section className="section">
          ...
          <p>Somatic-Behavioral resilience refers to physical self-regulation, body awareness, and the ability to ground oneself under stress. Teams with high somatic resilience understand their physical stress signals and have practices to restore balance and vitality.</p>
        ...
        <section className="section">
          ...
          <ol>
            <li>How do you know when you're in a stress response vs. a grounded, resourced state?</li>
            <li>What physical signals tell you that you — or a teammate — are approaching burnout?</li>
            <li>How does your physical environment (light, noise, movement) affect your focus and wellbeing?</li>
            <li>What collective habits support your physical wellbeing as a team?</li>
            <li>How do we create space for recovery and rest — not just productivity?</li>
            <li>What's one simple body-based practice we could add to our team rituals?</li>
            <li>How do we respond as a team when someone's energy is depleted?</li>
          </ol>
        </section>
        ...
        <section className="section">
          ...
          <ul>
            <li><strong>Body Scan (10 min):</strong> Guide the team through a brief body scan. Ask: Where do you hold tension? What does your body need right now?</li>
            <li><strong>Movement Break Design (15 min):</strong> As a team, design a 3-minute movement break protocol you'll use in meetings. Test it together.</li>
            <li><strong>Stress Signals Map (20 min):</strong> Each person identifies their personal stress signals. In pairs, share what you'd want colleagues to notice and how to respond helpfully.</li>
          </ul>
        </section>
        ...
        <section className="section">
          ...
          <ul>
            <li>What is your body telling you about your current level of resilience?</li>
            <li>What one physical practice will you commit to this week to support your wellbeing?</li>
            <li>How can the team create more space for physical recovery and rest?</li>
          </ul>
        </section>
