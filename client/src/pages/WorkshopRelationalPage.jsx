...
export default function WorkshopRelationalPage() {
  useEffect(() => {
    try {
    ...
    <>
      ...
      <div className="guide">
        ...
        <header className="guide-header">
          ...
          <h1 className="guide-header__title">Relational-Connective</h1>
          <p className="guide-header__sub">A facilitated team session to explore and strengthen Relational-Connective resilience</p>
        ...
        <section className="section">
          ...
          <p>Relational-Connective resilience refers to the capacity to build, maintain, and draw strength from meaningful human connections. Teams with strong relational resilience navigate adversity together, supporting each other through difficulty and finding renewal in shared experience.</p>
        ...
        <section className="section">
          ...
          <ol>
            <li>When do you feel most connected to your teammates — and what creates that feeling?</li>
            <li>What gets in the way of asking for support when you need it most?</li>
            <li>How do we acknowledge and celebrate each other's contributions as a team?</li>
            <li>What does belonging feel like in our team culture?</li>
            <li>Who in your network outside this team do you lean on, and do you have enough of those connections?</li>
            <li>What's one small thing we could do this week to feel more connected as a team?</li>
            <li>When someone is struggling, how do we notice and respond as a team?</li>
          </ol>
        </section>
        ...
        <section className="section">
          ...
          <ul>
            <li><strong>Connection Map (15 min):</strong> Each person draws their relational network. Share in pairs: Where are your strongest connections? Where are there gaps?</li>
            <li><strong>Appreciation Circle (10 min):</strong> Go around the team — each person shares one specific thing they appreciate about the person to their left.</li>
            <li><strong>Support Menu (20 min):</strong> Each team member writes their personal "support menu" — what kind of help they find most useful. Share and discuss.</li>
          </ul>
        </section>
        ...
        <section className="section">
          ...
          <ul>
            <li>What surprised you about your team's relational strengths and gaps?</li>
            <li>What is one thing you will do differently this week to strengthen a team connection?</li>
            <li>How can we build connection into our team rituals and routines?</li>
          </ul>
        </section>
