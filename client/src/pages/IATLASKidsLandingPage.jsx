        ...
        <div className="ikids-wrap">
          ...
          <section className="ikids-hero" aria-labelledby="ikids-hero-title">
            ...
            <span className="ikids-hero-kicker">
              ...
              <span title="Integrated Applied Teaching and Learning Analysis System">IATLAS™</span> Kids
            </span>
            ...
            <p className="ikids-hero-sub" style={{ fontStyle: 'italic', opacity: 0.85, marginBottom: '.5rem' }}>
              Resilience-building activities from the <strong>IATLAS</strong> (Integrated Applied Teaching and Learning Analysis System) curriculum
            </p>
            {activeProfile && (
          ...
          <div className="ikids-intro" role="region" aria-label="About IATLAS Kids">
            ...
            <p className="ikids-intro-text">
              <strong>IATLAS</strong> (Integrated Applied Teaching and Learning Analysis System) Kids brings the science of resilience into age-appropriate, play-based learning.
