        ...
        <div>
          ...
          {SECTIONS.map(sec => (
            ...
            >
              ...
              >
                {sec.icon && sec.icon.startsWith('/icons/') ? (
                  <img src={sec.icon} alt="" aria-hidden="true" className="icon icon-sm" />
                ) : (
              ...
              {sec.callout && (
                ...
                >
                  {sec.callout.icon && sec.callout.icon.startsWith('/icons/') ? (
                    <img src={sec.callout.icon} alt="" aria-hidden="true" style={{ width: 18, height: 18, flexShrink: 0, marginTop: 2 }} />
                  ) : (
              ...
              {sec.doList && (
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.25rem', marginBottom: '1.5rem' }}>
                  <div style={{ background: '#f0fdf4', border: '1px solid #bbf7d0', borderRadius: 10, padding: '1.25rem' }}>
                    <h3 style={{ color: '#14532d', fontSize: '.97rem', margin: '0 0 .75rem', display: 'flex', alignItems: 'center', gap: '.4rem' }}><img src="/icons/checkmark.svg" alt="" aria-hidden="true" style={{ width: 14, height: 14 }} /> Do</h3>
                  ...
                  <div style={{ background: '#fef2f2', border: '1px solid #fecaca', borderRadius: 10, padding: '1.25rem' }}>
                    <h3 style={{ color: '#991b1b', fontSize: '.97rem', margin: '0 0 .75rem', display: 'flex', alignItems: 'center', gap: '.4rem' }}><img src="/icons/somatic-regulative.svg" alt="" aria-hidden="true" style={{ width: 14, height: 14 }} /> Don't</h3>
