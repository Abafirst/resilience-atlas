...
export const IATLAS_TIER_CONFIG = {
  ...
  family: {
    ...
    features: [
      ...
      'Family challenge activities (Coming Soon)',
    ],
    comingSoon: false,
  },
  complete: {
  ...
  practitioner: {
    ...
    color: '#059669',
    features: [
      'Clinical assessments & session plans (Coming Soon)',
      'Client resources & worksheets',
      'ABA protocol library (Coming Soon)',
      'Progress & outcome reports (Coming Soon)',
      'Individual practice',
    ],
    comingSoon: false,
  },
