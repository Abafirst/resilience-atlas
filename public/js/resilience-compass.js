...
(function () {
  ...
  var DARK_PALETTE = {
    ...
    ringInner:      'rgba(255,255,255,0)',
    ringOuter:      'rgba(255,255,255,0)',
    ringShadow:     'rgba(56,189,248,0.25)',
    bezel:          'rgba(255,255,255,0)',
    bezelHighlight: 'rgba(255,255,255,0)',
    bezelShadow:    'rgba(56,189,248,0)',
    ...
    glassRingFill:  'rgba(255,255,255,.03)',
    glassRingStroke:'rgba(255,255,255,.10)',
    polyStroke:     '#A78BFA',
