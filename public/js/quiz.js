...
const QUESTIONS = [
  ...
  { id: 1,  category: 'Agentic-Generative', text: 'In general, I take action to improve difficult situations.' },
  { id: 2,  category: 'Agentic-Generative', text: 'In general, I pursue meaningful goals even during stress.' },
  { id: 3,  category: 'Agentic-Generative', text: 'In general, I create opportunities even when things are hard.' },
  { id: 4,  category: 'Agentic-Generative', text: 'In general, I stay motivated when facing adversity.' },
  { id: 5,  category: 'Agentic-Generative', text: 'In general, I generate new possibilities in challenging times.' },
  { id: 6,  category: 'Agentic-Generative', text: 'In general, I move forward with purpose after setbacks.' },
  { id: 7,  category: 'Agentic-Generative', text: 'In general, I take initiative even when outcomes are uncertain.' },
  { id: 8,  category: 'Agentic-Generative', text: 'In general, I can identify concrete steps to address challenges.' },
  { id: 9,  category: 'Agentic-Generative', text: 'In general, I feel empowered to create positive change in my life.' },
  { id: 10, category: 'Agentic-Generative', text: 'In general, I follow through on decisions even when they are difficult.' },
  { id: 11, category: 'Agentic-Generative', text: 'In general, I view obstacles as opportunities to demonstrate my capability.' },
  { id: 12, category: 'Agentic-Generative', text: 'In general, I take responsibility for my resilience journey.' },

  // Relational (Q13-24)
  { id: 13, category: 'Relational-Connective', text: 'In general, I reach out to others when I need support.' },
  { id: 14, category: 'Relational-Connective', text: 'In general, I maintain supportive relationships.' },
  { id: 15, category: 'Relational-Connective', text: 'In general, I feel connected to my community.' },
  { id: 16, category: 'Relational-Connective', text: 'In general, I contribute to the well-being of others.' },
  { id: 17, category: 'Relational-Connective', text: 'In general, I communicate openly with people I trust.' },
  { id: 18, category: 'Relational-Connective', text: 'In general, I rely on my relationships to help me through challenges.' },
  ...
  { id: 25, category: 'Spiritual-Reflective', text: 'In general, I have a sense of purpose that guides me.' },
  { id: 26, category: 'Spiritual-Reflective', text: 'In general, I draw on my values to orient me during difficult times.' },
  { id: 27, category: 'Spiritual-Reflective', text: 'In general, I reflect on deeper meaning in life events.' },
  { id: 28, category: 'Spiritual-Reflective', text: 'In general, I feel connected to something larger than myself.' },
  { id: 29, category: 'Spiritual-Reflective', text: 'In general, I draw on my beliefs to stay grounded.' },
  { id: 30, category: 'Spiritual-Reflective', text: 'In general, I draw on a sense of purpose for strength during adversity.' },
  { id: 31, category: 'Spiritual-Reflective', text: 'In general, I understand what gives my life meaning and purpose.' },
  { id: 32, category: 'Spiritual-Reflective', text: 'In general, I draw on contemplative or spiritual practices to restore inner calm.' },
  { id: 33, category: 'Spiritual-Reflective', text: 'In general, I find gratitude and appreciation even in the midst of adversity.' },
  { id: 34, category: 'Spiritual-Reflective', text: 'In general, I find that adversity deepens my sense of what matters most.' },
  { id: 35, category: 'Spiritual-Reflective', text: 'In general, I find resilience through spiritual or philosophical practice.' },
  { id: 36, category: 'Spiritual-Reflective', text: 'In general, I have a clear sense of meaning that helps me endure hardship.' },

  // Emotional-Adaptive (Q37-48)
  { id: 37, category: 'Emotional-Adaptive', text: 'In general, I can adapt emotionally to stressful situations.' },
  { id: 38, category: 'Emotional-Adaptive', text: 'In general, I manage difficult emotions effectively.' },
  { id: 39, category: 'Emotional-Adaptive', text: 'In general, I recover emotionally after setbacks.' },
  { id: 40, category: 'Emotional-Adaptive', text: 'In general, I can tolerate emotional discomfort when needed.' },
  { id: 41, category: 'Emotional-Adaptive', text: 'In general, I regulate my emotional reactions well.' },
  { id: 42, category: 'Emotional-Adaptive', text: 'In general, I let my emotions help guide my decisions.' },
  { id: 43, category: 'Emotional-Adaptive', text: 'In general, I can sit with uncomfortable emotions without being overwhelmed.' },
  { id: 44, category: 'Emotional-Adaptive', text: 'In general, I understand the messages my emotions are sending.' },
  { id: 45, category: 'Emotional-Adaptive', text: 'In general, I recognize when I need emotional support and actively seek it.' },
  { id: 46, category: 'Emotional-Adaptive', text: 'In general, I can express difficult emotions in healthy ways.' },
  { id: 47, category: 'Emotional-Adaptive', text: 'In general, I find my emotions provide valuable information about my needs.' },
  { id: 48, category: 'Emotional-Adaptive', text: 'In general, I maintain emotional balance during stressful periods.' },

  // Somatic-Regulative (Q49-60)
  { id: 49, category: 'Somatic-Regulative', text: 'In general, I use physical movement to help regulate stress.' },
  { id: 50, category: 'Somatic-Regulative', text: 'In general, I notice how my body reacts to stress.' },
  { id: 51, category: 'Somatic-Regulative', text: 'In general, I maintain consistent daily habits that provide a stable foundation for my well-being.' },
  { id: 52, category: 'Somatic-Regulative', text: 'In general, I use breathing or physical grounding to help me reset.' },
  { id: 53, category: 'Somatic-Regulative', text: 'In general, I find that sleep and rest influence my resilience.' },
  { id: 54, category: 'Somatic-Regulative', text: 'In general, I find that exercise or movement improves my mood.' },
  { id: 55, category: 'Somatic-Regulative', text: 'In general, I prioritize rest and recovery as key components of my resilience.' },
  { id: 56, category: 'Somatic-Regulative', text: 'In general, I treat my body as a resource I actively care for.' },
  { id: 57, category: 'Somatic-Regulative', text: 'In general, I use nutrition and hydration intentionally to support my energy and mood.' },
  { id: 58, category: 'Somatic-Regulative', text: 'In general, I maintain consistency in sleep, movement, and nutrition.' },
  { id: 59, category: 'Somatic-Regulative', text: 'In general, I find that my physical well-being directly impacts my resilience.' },
  { id: 60, category: 'Somatic-Regulative', text: 'In general, I use somatic techniques (breathing, stretching, etc.) intentionally.' },

  // Cognitive-Narrative (Q61-72)
  { id: 61, category: 'Cognitive-Narrative', text: 'In general, I reflect on difficult experiences to learn from them.' },
  { id: 62, category: 'Cognitive-Narrative', text: 'In general, I can reframe setbacks in a constructive way.' },
  { id: 63, category: 'Cognitive-Narrative', text: 'In general, I draw on my personal story to understand challenges.' },
  { id: 64, category: 'Cognitive-Narrative', text: 'In general, I find meaning in difficult experiences.' },
  { id: 65, category: 'Cognitive-Narrative', text: 'In general, I actively interpret events in ways that support growth.' },
  { id: 66, category: 'Cognitive-Narrative', text: 'In general, I use reflection to help me move forward after adversity.' },
  { id: 67, category: 'Cognitive-Narrative', text: 'In general, I actively construct meaningful narratives from my experiences.' },
  { id: 68, category: 'Cognitive-Narrative', text: 'In general, I can identify growth and learning from past difficulties.' },
  { id: 69, category: 'Cognitive-Narrative', text: 'In general, I use storytelling to make sense of challenges.' },
  { id: 70, category: 'Cognitive-Narrative', text: 'In general, I challenge unhelpful thinking patterns.' },
  { id: 71, category: 'Cognitive-Narrative', text: 'In general, I maintain perspective during adversity.' },
  { id: 72, category: 'Cognitive-Narrative', text: 'In general, I integrate difficult experiences into my life narrative.' },
];
...
function buildQuestionCards() {
  ...
  state.questionOrder.forEach((origIdx, displayIdx) => {
    ...
    card.innerHTML = `
      <p class="question-frequency-prompt">How often is this true for you?</p>
